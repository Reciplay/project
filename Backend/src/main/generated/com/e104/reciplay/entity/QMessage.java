...
public class QMessage extends EntityPathBase<Message> {
    ...
    private static final long serialVersionUID = 1406181676L;
    ...
    public final DateTimePath<java.time.LocalDateTime> notifiedAt = createDateTime("notifiedAt", java.time.LocalDateTime.class);
