...
public class SubscriptionApiController {
    ...
    public ResponseEntity<ResponseRoot<List<SubscriptionInfo>>> getSubscriptions(){
        ...
        List<SubscriptionInfo> subsciptionInfos = subscriptionQueryService.queryUserSubscriptionsByUserId(userId);
