    ...
    return (
        <div>
            ...
            <section className={styles.detail}>
                ...
                <Flex vertical gap={12}>
                    <InputNumber placeholder="모집 최대 인원을 설정해주세요" variant="underlined" style={{ width: 300 }} />
                </Flex>
                <Flex vertical gap={12}>
                    <InputNumber placeholder="강좌의 난이도를 설정해주세요 (1~100)" variant="underlined" style={{ width: 300 }} />
                </Flex>
            </section>
